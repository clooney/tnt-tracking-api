TNT Tracking API - PHP
================================
Use PHP to track TNT shipments with TNT Tracking API.
...
Create a tracking (Real-time tracking):
      ...
      try {
        $params = ['tracking_number'=>'0301006785462006320995','courier_code'=>'tnt'];
...
Create trackings (Max. 40 tracking numbers create in one call):
        ...
        try {
            $params = [
                ['tracking_number'=>'LK201223662AU','courier_code'=>'tnt'],
                ['tracking_number'=>'LH290032509AU','courier_code'=>'tnt']
            ];
...
Get status of the shipment:
    ...
    try {
        ...
        $params = ['courier_code'=>'tnt','created_date_min'=>'2023-08-23T06:00:00+00:00','created_date_max'=>'2023-09-05T07:20:42+00:00'];
