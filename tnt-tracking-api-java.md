TNT Tracking API - Java
================================
Use Java to track TNT shipments with TNT Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.tnt;
    ...
    public class CreateTntTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setCourierCode("tnt");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateTntTrackingsExample {
...
Get status of the shipment:
    ...
    public class GetTntTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                trackingParams.setCourierCode("tnt");
...
Update a tracking by ID:
    ...
    public class UpdateTntTrackingExample {
