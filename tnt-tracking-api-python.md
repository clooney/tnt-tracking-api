TNT Tracking API - Python
================================
Use Python to track TNT shipments with TNT Tracking API.
...
Get status of the shipment:
    ...
    try:
      ...
      # params = {'courier_code': 'tnt'}
      # params = {'tracking_numbers': 'LK201223662AU,LH290032509AU', 'courier_code': 'tnt'}
